...
const Btn_green = () => {
  return (
    <div className="my-5 min-w-[200px]">    
        <a href="#_" className="relative mt-3 px-5 py-3 font-medium text-white transition duration-300 bg-green-600 rounded-md hover:bg-green-900 ease">
            <span className="absolute bottom-0 left-0 h-full -ml-2 dark:hidden">
            ...
            <span className="absolute top-0 right-0 w-12 h-full -mr-3 dark:hidden">
